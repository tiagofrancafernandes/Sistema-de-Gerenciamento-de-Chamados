...
let colorIcon = computed(() => {
    let svgList = {
        ...
        light: `<svg class="w-5 h-5 inline-flex items-center mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon">
        ...
        `,
        system: `<svg class="w-5 h-5 inline-flex items-center mr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" id="mdi-theme-light-dark" viewBox="0 0 24 24">
